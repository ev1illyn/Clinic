            ...
            <div class="ui grid stackable">
                ...
                <div class="twelve wide column right aligned">
                    <div class="ui text container segment">
                        <h2 class="ui header center aligned">Cadastrar Paciente</h2>
                        <form action="${pageContext.request.contextPath}/patient/save" method="post" class="ui form">
                            <h4 class="ui dividing left aligned header info">Informações Pessoais</h4>
                            <div class="field">
                                <div class="fields">
                                    <div class="nine wide field">
                                        <label>Nome</label>
                                        <input type="text" name="patient.name" value="${patient.name}" value="${patient.name}" maxlength="255" placeholder="Ex: Evillyn da Silva Oliveira">
                                    </div>
                                    ...
                                    <div class="five wide field">
                                        <label>CPF</label>
                                        <input type="text" name="patient.cpf" value="${patient.cpf}" placeholder="Ex: 999-999-999-09" pattern="[0-9]{11}" title="digite um cpf válido" required>
                                    </div>
                                </div>
                            </div>		
                            ...
                            <div class="fields">
                                <div class="eight wide field">
                                    <label>Email</label>
                                    <input type="text" name="patient.contact.email" value="${patient.contact.email}" placeholder="Ex: evillyndsoliveiras@gmail.com"pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
                                </div>
                                <div class="eight wide field">
                                    <label>Telefone</label>
                                    <input type="number" name="patient.contact.phone" value="${patient.contact.phone}" placeholder="Ex: 988776655" required>
                                </div>
                            </div>
