<%-- 
    Document   : updateView
    Created on : 28/11/2018, 15:10:40
            ...
            <div class="ui grid stackable">
                ...
                <div class="twelve wide column right aligned">
                    <div class="ui text container segment">
                        <h2 class="ui header center aligned">Atualizar Funcionário</h2>
                        <form action="${pageContext.request.contextPath}/employee/update" method="post" class="ui form">
                            ...
                            <div class="field">
                                <div class="fields">
                                    <div class="nine wide field">
                                        <label>Nome</label>
                                        <input type="text" name="employee.name" value="${employee.name}" maxlength="255" placeholder="Ex: Evillyn da Silva Oliveira" required>
                                    </div>
                            ...
                            <div class="fields">
                                ...
                                <div class="eight wide field">
                                    ...
                                    <input type="text" name="employee.contact.phone" value="${employee.contact.phone}" placeholder="Ex: 988776655" required>
                                </div>
                            </div>
